...
CREATE TABLE public._alembic_version (
    version_num text DEFAULT NULL::character varying
);
...
CREATE TABLE public._archived_attendance (
    id text DEFAULT NULL::character varying,
    employee_id text DEFAULT NULL::character varying,
    date text DEFAULT NULL::character varying,
    arrival_time text DEFAULT NULL::character varying,
    departure_time text DEFAULT NULL::character varying
);
...
CREATE TABLE public._archived_employees (
    id smallint,
    telegram_id text DEFAULT NULL::character varying,
    email text DEFAULT NULL::character varying,
    role text DEFAULT NULL::character varying,
    name text DEFAULT NULL::character varying,
    birthday text DEFAULT NULL::character varying,
    registered smallint,
    greeted smallint,
    training_passed smallint,
    full_name text DEFAULT NULL::character varying,
    "position" text DEFAULT NULL::character varying,
    contract_number text DEFAULT NULL::character varying,
    employment_date text DEFAULT NULL::character varying,
    contact_info text DEFAULT NULL::character varying,
    branch text DEFAULT NULL::character varying,
    cooperation_format text DEFAULT NULL::character varying,
    dismissal_date text DEFAULT NULL::character varying,
    original_employee_id text DEFAULT NULL::character varying
);
...
CREATE TABLE public._archived_ideas (
    ...
    idea_text text DEFAULT NULL::character varying,
    submission_date text DEFAULT NULL::character varying
);
...
CREATE TABLE public._employee_custom_data (
    id smallint,
    employee_id smallint,
    data_key text DEFAULT NULL::character varying,
    data_value text DEFAULT NULL::character varying
);
...
CREATE TABLE public._employees (
    ...
    cooperation_format text DEFAULT NULL::character varying,
    training_passed smallint,
    last_seen text DEFAULT NULL::character varying,
    is_active smallint,
    onboarding_completed smallint,
    photo_file_id text DEFAULT NULL::character varying,
...
CREATE TABLE public._events (
    ...
    description text DEFAULT NULL::character varying,
    event_date text DEFAULT NULL::character varying,
    created_at text DEFAULT NULL::character varying
);
...
CREATE TABLE public._onboarding_questions (
    ...
    question_text text DEFAULT NULL::character varying,
    data_key text DEFAULT NULL::character varying,
...
CREATE TABLE public._onboarding_steps (
    ...
    role text DEFAULT NULL::character varying,
    order_index smallint,
    message_text text DEFAULT NULL::character varying,
    file_path text DEFAULT NULL::character varying,
    file_type text DEFAULT NULL::character varying
);
...
CREATE TABLE public._quiz_questions (
    id smallint,
    role text DEFAULT NULL::character varying,
    question text DEFAULT NULL::character varying,
    answer text DEFAULT NULL::character varying,
    order_index smallint,
    question_type text DEFAULT NULL::character varying,
    options text DEFAULT NULL::character varying
);
...
CREATE TABLE public._role_guides (
    ...
    role text DEFAULT NULL::character varying,
    title text DEFAULT NULL::character varying,
    content text DEFAULT NULL::character varying,
    file_path text DEFAULT NULL::character varying,
    order_index smallint
);
...
CREATE TABLE public._topics (
    ...
    title text DEFAULT NULL::character varying,
    content text DEFAULT NULL::character varying,
    category text DEFAULT NULL::character varying,
    image_path text DEFAULT NULL::character varying
);
